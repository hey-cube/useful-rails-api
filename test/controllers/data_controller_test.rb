...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { date: @datum.date, label: @datum.label, value: @datum.value } }, as: :json
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { date: @datum.date, label: @datum.label, value: @datum.value } }, as: :json
    assert_response 200
  end
